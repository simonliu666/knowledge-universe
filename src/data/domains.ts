    ...
    subDomains: [
      {
        ...
        totalPoints: 11,
        modules: [
          { id: "micro", name: "微观经济学", description: "供需、价格与个体决策", totalPoints: 6 },
          { id: "macro", name: "宏观经济学", description: "GDP、通胀与货币政策", totalPoints: 5 },
        ],
      },
      {
        ...
        totalPoints: 7,
        modules: [
          { id: "behavioral", name: "行为经济学", description: "心理偏差如何影响经济决策", totalPoints: 4 },
          { id: "game-theory", name: "博弈论", description: "策略互动与纳什均衡", totalPoints: 3 },
        ],
      },
    ],
  },
